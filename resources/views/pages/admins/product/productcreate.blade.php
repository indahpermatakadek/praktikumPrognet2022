                    ...
                    <div class="card-body">
                        <form class="form-signin" action="/admins/products/store" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                                ...
                                <div class="input-group input-group-outline my-3">                                    
                                    <input type="number" class="form-control" placeholder="Berat Produk" name="weight">
                                </div>
                                ...
                                <div class="input-group input-group-outline my-3">                                    
                                    <input type="file" class="form-control" placeholder="" name="files[]" onchange="showPreview(event);">
                                </div>
                                <br>
                                <div>
